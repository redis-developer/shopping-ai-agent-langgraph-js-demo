...
console.log('\n🔍 Expected Values:');
console.log('   BEDROCK_CONVERSATION_GUARDRAIL_ID should be: 4icw4uthyebe');
console.log('   BEDROCK_CACHE_GUARDRAIL_ID should be: g7t10xfo69kp');
console.log('   BEDROCK_GUARDRAIL_VERSION should be: 1');
...
if (CONFIG.bedrockConversationGuardrailId !== '4icw4uthyebe') {
    console.log('   ⚠️  Conversation guardrail ID mismatch');
}

if (CONFIG.bedrockCacheGuardrailId !== 'g7t10xfo69kp') {
    console.log('   ⚠️  Cache guardrail ID mismatch');
}

console.log('\n🧪 Next Steps:');
console.log('   1. Check AWS Console for guardrail usage');
